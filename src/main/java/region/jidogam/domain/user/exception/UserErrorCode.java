...
public enum UserErrorCode implements ErrorCode {
  ...
  USER_DELETED(HttpStatus.FORBIDDEN, "USER_09", "탈퇴한 사용자입니다. 복구를 원하시면 복구 페이지를 이용해주세요."),
  USER_ALREADY_DELETED(HttpStatus.BAD_REQUEST, "USER_10", "이미 탈퇴한 사용자입니다."),
  USER_RESTORE_PERIOD_EXPIRED(HttpStatus.GONE, "USER_11", "복구 가능 기간이 만료되었습니다.");
